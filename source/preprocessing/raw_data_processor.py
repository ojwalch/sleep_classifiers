...
class RawDataProcessor:
    ...
    @staticmethod
    def crop_all_disordered(subject_id):
        psg_raw_collection = PSGService.read_precleaned_disordered(subject_id)
        motion_collection = MotionService.load_raw_disordered(subject_id)
        heart_rate_collection = HeartRateService.load_raw_disordered(
            subject_id)
